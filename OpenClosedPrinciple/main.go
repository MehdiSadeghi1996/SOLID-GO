...
// Filter / در اینجا open closed principle رعایت نشده و برای هر درخواستی ما مجبور به تغییرات در کلاس فیلتر هستیم و دوباره تست کردن آن
type Filter struct {
}
...
///////////////////////////////   بعد از رعایت open closed principle

// Specification pattern

// Specification / هیچ موقع نیازی به مودیفیکیشن این اینترفیس نیست
...
// BetterFilter / این تایپ هم اینترفیس بالا رو پیاده سازی کرده و نیازی به مودیفیکیشن نداره
...
func main() {
	...
	//// روشی که open closed principle رعایت نشده
	...
	//// در اینجا open closed principle رعایت شده
	fmt.Print("Green products :\n")
